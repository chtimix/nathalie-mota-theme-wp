...
//   // Gestion ouverture/fermeture des filtres
...
//       // Si le filtre est déjà ouvert, on le ferme
//       const isOpen = select.classList.contains('open');

//       // Ferme tous les autres filtres
//       customSelects.forEach(s => s.classList.remove('open'));

//       // Si le filtre cliqué n'était pas ouvert, on l’ouvre
//       if (!isOpen) {
...
//   // Ferme tous les filtres si on clique ailleurs
